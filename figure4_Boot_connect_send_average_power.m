...
hold on;
title('Pycom 30 Second T_i'  , 'FontSize', 16)
set(gcf, 'color', [1 1 1])
lgd = legend;
lgd.FontSize = 12;
xlabel('Time (s)'  , 'FontSize', 16)
ylabel('Power (mW)'  , 'FontSize', 16)
plot(E5Full1_time, pycom1_current, 'DisplayName','Run 1');
plot(E5Full1_time, pycom2_current, 'DisplayName','Run 2');
plot(E5Full1_time, pycom3_current, 'DisplayName','Run 3');
plot(E5Full1_time, pycom4_current, 'DisplayName','Run 4');
plot(E5Full1_time, pycom5_current, 'DisplayName','Run 5');


subplot(2,2,2)

hold on;
title('E5 Full 30 Second T_i'  , 'FontSize', 16)
set(gcf, 'color', [1 1 1])
lgd = legend;
lgd.FontSize = 12;
xlabel('Time (s)'  , 'FontSize', 16)
ylabel('Power (mW)'  , 'FontSize', 16)
plot(E5Full1_time, E5Full1_current, 'DisplayName','Run 1');
plot(E5Full1_time, E5Full2_current, 'DisplayName','Run 2');
plot(E5Full1_time, E5Full3_current, 'DisplayName','Run 3');
plot(E5Full1_time, E5Full4_current, 'DisplayName','Run 4');
plot(E5Full1_time, E5Full5_current, 'DisplayName','Run 5');


subplot(2,2,3)

hold on;
title('E5 Mini 30 Second T_i'  , 'FontSize', 16)
set(gcf, 'color', [1 1 1])
lgd = legend;
lgd.FontSize = 12;
xlabel('Time (s)'  , 'FontSize', 16)
ylabel('Power (mW)'  , 'FontSize', 16)
plot(E5Mini1_time, E5Mini1_current, 'DisplayName','Run 1');
plot(E5Mini1_time, E5Mini2_current, 'DisplayName','Run 2');
plot(E5Mini1_time, E5Mini3_current, 'DisplayName','Run 3');
plot(E5Mini1_time, E5Mini4_current, 'DisplayName','Run 4');
plot(E5Mini1_time, E5Mini5_current, 'DisplayName','Run 5');

subplot(2,2,4)

hold on;
title('Grasshopper 30 Second T_i'  , 'FontSize', 16)
set(gcf, 'color', [1 1 1])
lgd = legend;
lgd.FontSize = 12;
xlabel('Time (s)'  , 'FontSize', 16)
ylabel('Power (mW)'  , 'FontSize', 16)
plot(Grasshopper1_time, Grasshopper1_current, 'DisplayName','Run 1');
plot(Grasshopper1_time, Grasshopper2_current, 'DisplayName','Run 2');
plot(Grasshopper1_time, Grasshopper3_current, 'DisplayName','Run 3');
plot(Grasshopper1_time, Grasshopper4_current, 'DisplayName','Run 4');
plot(Grasshopper1_time, Grasshopper5_current, 'DisplayName','Run 5');
...
e5full_average = [trapz(E5Full1_time, E5Full1_current) trapz(E5Mini2_time, E5Mini2_current) trapz(E5Mini3_time, E5Mini3_current) trapz(E5Mini4_time, E5Mini4_current) trapz(E5Mini5_time, E5Mini5_current)]'
grasshopper_average = [trapz(E5Mini1_time, E5Mini1_current) trapz(E5Mini2_time, E5Mini2_current) trapz(E5Mini3_time, E5Mini3_current) trapz(E5Mini4_time, E5Mini4_current) trapz(E5Mini5_time, E5Mini5_current)]'
